...
用鼠标移动插入点，就可以触发ITfComposition输入组合的意外终止。

## 2.7.4 插入点与文本范围

TF_SELECTION文本选定结构中的ITfRange文本范围，保存的是当前按键转换的编码。<br/>
ITfComposition输入组合中的ITfRange文本范围，保存的是所有按键转换的编码组合。<br/>
这是容易混淆的地方之一。<br/>
更加令人困惑的是插入点和文本范围的区间。

文本范围并不是文本流的绝对索引，而是用开始点和结束点标记的相对区间。<br/>
本文以[开始点，结束点)来描述一个文本流的相对区间。<br/>
以插入点来指称TF_SELECTION文本选定结构中ITfRange文本范围的相对区间。<br/>
以文本范围来指称ITfComposition输入组合中ITfRange文本范围的相对区间。
